...
fn test_recursive_load() {
  ...
  assert_eq!(
    ...
    Some(vec![
      ModuleRequest {
        ...
        specifier_key: Some("file:///b.js".to_string()),
      ...
      ModuleRequest {
        ...
        specifier_key: Some("file:///c.js".to_string()),
  ...
  assert_eq!(
    ...
    Some(vec![ModuleRequest {
      ...
      specifier_key: Some("file:///d.js".to_string()),
      referrer_source_offset: Some(19),
      phase: crate::modules::ModuleImportPhase::Evaluation,
    },])
  );
    ...
    assert_eq!(
      ...
      Some(vec![
        ModuleRequest {
          ...
          specifier_key: Some("file:///c.json".to_string()),
        ...
        ModuleRequest {
          ...
          specifier_key: Some("file:///d.txt".to_string()),
        ...
        ModuleRequest {
          ...
          specifier_key: Some("file:///e.bin".to_string()),
  ...
  let fut = async move {
    ...
    assert_eq!(
      ...
      Some(vec![ModuleRequest {
        ...
        specifier_key: Some("file:///circular2.js".to_string()),
    ...
    assert_eq!(
      ...
      Some(vec![ModuleRequest {
        ...
        specifier_key: Some("file:///circular3.js".to_string()),
        referrer_source_offset: Some(8),
        phase: crate::modules::ModuleImportPhase::Evaluation,
      }])
    );
    ...
    assert_eq!(
      ...
      Some(vec![
        ModuleRequest {
          ...
          specifier_key: Some("file:///circular1.js".to_string()),
          referrer_source_offset: Some(8),
          phase: crate::modules::ModuleImportPhase::Evaluation,
        },
        ModuleRequest {
