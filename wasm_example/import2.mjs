...
console.log("dprint plugin version", dprintPlugin.exports.get_plugin_schema_version());
console.log("dprint plugin get_wasm_memory_buffer_size", dprintPlugin.exports.get_wasm_memory_buffer_size());